...
export default function NewRecurringTemplatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      showToast("Template surplus rutin dibuat!", "success");
      router.push("/app/surplus/recurring");
    } catch (err) {
      console.error(err);
      setError("Gagal membuat template rutin. Silakan coba lagi.");
    } finally {
  ...
  return (
    <div className="px-4 sm:px-6 py-6 max-w-xl mx-auto">
      ...
      <div className="mb-6">
        <h1 className="text-xl font-bold text-[#1B1F1C]">Buat Surplus Rutin</h1>
        <p className="text-sm text-[#9AA39C]">Tambahkan template untuk posting terjadwal</p>
      </div>
